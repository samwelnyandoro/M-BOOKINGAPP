package com.example.m_bookingapp.utils
            ...
            message.contains("1 bus service") -> {
                when (random) {
                    0 -> "What is bus booking? => here, Bus booking provides you to choose your university Up-Down transportation through your internet" +
                            ...
                            "\nWhy is bus Booking? => To provide you hassle free seating booking on your finger tip and connecting your journey with technology on Internet." +
                            "\nOur services \n" +
